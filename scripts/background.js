...
async function handleScoreCandidate(tabId, jobTitle, jobDescription, jobLanguage, sendResponse) {
    try {
        ...
        // BUG 2 FIX: increased delay from 150ms to 600ms to allow LinkedIn's dynamic content to load
        ...
        // BUG 2 FIX: retry once if scrape failed (LinkedIn may still be loading)
